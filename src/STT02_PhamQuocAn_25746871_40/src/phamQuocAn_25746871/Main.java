...
public class Main {
    ...
    static void menu() {
        ...
        System.out.println("| 3. Sửa thực phẩm                      |");
    ...
    static void themThucPham() {
        try {
            ...
            if (ql.them(h)) {
                ...
                System.out.println(" Thêm thất bại (Có thể trùng mã hàng)!");
            }
        } catch (Exception e) {
    ...
    static void suaThucPham() {
        try {
            ...
            if (ql.sua(id, ten, sx, hh, gia)) {
                System.out.println(" Đã sửa id " + id);
            }
        } catch (Exception e) {
    ...
    static void sapXepMenu() {
        ...
        switch (c) {
            ...
            case "c": ql.sapXepTheoNgaySX(true); break;  
            case "d": ql.sapXepTheoNgaySX(false); break; 
    ...
    static void timKiemMenu() {
        ...
        System.out.println("a. Tìm theo tiền tố | b. Tìm theo hậu tố | c. Tìm gần đúng");
        System.out.print("Chọn: ");
        String c = sc.nextLine().toLowerCase();
        ...
        switch (c) {
            ...
            case "c": kq = ql.timGanDung(tk); break;
            default: 
                System.out.println(" Không hợp lệ!"); 
                return;
        }
    ...
    static void thongKe() {
        ...
        // ĐÃ SỬA: Đổi tinhTongGiaTri1() thành tinhTongGiaTri()
