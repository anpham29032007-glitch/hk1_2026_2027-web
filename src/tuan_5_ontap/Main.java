...
import java.util.Scanner;
	public class Main {
	    ...
	    static void timTheoTienTo(CDList ql) {
	        ...
	        System.out.println("🔎 Tìm thấy " + kq.getSoLuong() + " kết quả (bắt đầu bằng '" + tk + "'):");
	        kq.hienThiDanhSach();
	    }
	    ...
	    static void timTheoHauTo(CDList ql) {
	        ...
	        System.out.println("🔎 Tìm thấy " + kq.getSoLuong() + " kết quả (kết thúc bằng '" + tk + "'):");
	        kq.hienThiDanhSach();
	    }
	    ...
	    static void timGanGiong(CDList ql) {
	        ...
	        System.out.println("🔎 Tìm thấy " + kq.getSoLuong() + " kết quả (chứa '" + tk + "'):");
	        kq.hienThiDanhSach();
	    }
